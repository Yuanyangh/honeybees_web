$(document).ready(async function() {
  const teamMembers = [
    ...
    {
      name: "Ian Lin",
      image: "assets/img/TeamMembers/Ian_Lin.jpg",
    ...
    {
      name: "Wang Yaxiang",
      image: "assets/img/TeamMembers/Wang_Yaxiang.jpg",
    ...
    {
      name: "Kylie Ng",
      image: "assets/img/TeamMembers/Kylie_Ng.jpg",
    ...
    {
      name: "Kenneth Chng",
      image: "assets/img/TeamMembers/Kenneth_Chng.jpg",
      role: ["Personal Wealth Manager"],
    ...
    {
      name: "Pamela Ng",
      image: "assets/img/TeamMembers/Pamela_Ng.jpg",
      role: ["Senior Personal Wealth Manager"],
      qualification: ["2x MDRT Qualifier"],
    ...
    {
      name: "Jacqueline Tan",
      image: "assets/img/TeamMembers/Jacqueline_Tan.jpg",
      role: ["Personal Wealth Manager"],
      qualification: ["2x MDRT Qualifier"],
    ...
    {
      name: "Goh Li Ying",
      image: "assets/img/TeamMembers/Goh_Li_Ying.jpg",
      role: ["Financial Services Consultant"],
      qualification: ["2x MDRT Qualifier"],
    ...
    {
      name: "Lim Yu Heng",
      image: "assets/img/TeamMembers/Lim_Yu_Heng.jpg",
      role: ["Personal Wealth Manager"],
      qualification: ["2x MDRT Qualifier"],
